...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(latex-pretty-symbols company company-auctex writeroom-mode visual-fill-column abbrev skeleton tempo)
